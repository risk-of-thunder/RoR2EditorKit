...
{
    /// <summary>
    /// A <see cref="ComponentInspector{T}"/> that allows you to implement the UI using VisualElements. It utilizes UXML Templates and finds the proper template by searching for a Template that has the same name as your inspector's class name.
    /// 
    ...
    public abstract class VisualElementComponentInspector<T> : ComponentInspector<T> where T : Component
    {
        ...
        /// <para>For <see cref="VisualElementComponentInspector{T}"/>, utilize <see cref="InitializeVisualElement"/> instead to initialize your visual element</para>
        /// </summary>
